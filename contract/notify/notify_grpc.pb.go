...
func (c *notifyClient) SendEmail(ctx context.Context, in *SendEmailRequest, opts ...grpc.CallOption) (*SendEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendEmailResponse)
	err := c.cc.Invoke(ctx, Notify_SendEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNotifyServer) SendEmail(context.Context, *SendEmailRequest) (*SendEmailResponse, error) {
...
func _Notify_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotifyServer).SendEmail(ctx, req.(*SendEmailRequest))
	}
...
var Notify_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "contract/notify/notify.proto",
}
